...
<div style="width:800px; margin:0 auto; text-align:center;">
    <form id="playImgEnroll-Frm"
        action="<%=request.getContextPath()%>/product/play/playImgEnroll" method="POST" enctype="multipart/form-data">
        <table class="table  table-bordered">
            <tr>
                <th colspan="3">체험사진업로드</th>
            </tr>
            <tr>
    ...
    $("#playImgEnroll-Frm").submit(function(e){
