...
@WebServlet("/board/notice/boardList")
public class NoticeBoardListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			List<Board>noticeList= noticeService.selectNoticeList(cpage, numPerPage);  //게시물 조회
			
			// totalContents 총 게시물 수
			int totalContents = noticeService.selectTotalNoticeBoards();
			...
			request.getRequestDispatcher("/WEB-INF/views/board/noticeBoard/noticeBoardList.jsp").forward(request, response);
