 ...
 */
@WebServlet("/board/notice/boardDelete")
public class NoticeBoardDeleteServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//2.업무로직
		int result = noticeService.deleteNoticeBoard(boardNo);
		...
		response.sendRedirect(request.getContextPath() + "/board/notice/boardList");
	}
