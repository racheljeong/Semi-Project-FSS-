...
@WebServlet("/board/newHost/boardList")
public class NewHostBoardListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			List<BoardExt> hostList = newHostService.selectNewHostList(cpage, numPerPage);  //게시물 조회
			
			// totalContents 총 게시물 수
			int totalContents = newHostService.selectTotalNHBoards();
//			System.out.println("totalContents@listServlet =" +totalContents);
...
//			System.out.println("pageBar= "+pageBar);
			...
			request.getRequestDispatcher("/WEB-INF/views/board/newHostBoard/newHostBoardList.jsp").forward(request, response);
