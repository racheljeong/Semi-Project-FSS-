...
@WebServlet("/board/review/boardList")
public class ReviewBoardListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			List<BoardExt> reviewList= reviewService.selectReviewList(cpage, numPerPage);  //게시물 조회
			
			// totalContents 총 게시물 수
			int totalContents = reviewService.selectTotalReviewBoards();
			...
			request.getRequestDispatcher("/WEB-INF/views/board/reviewBoard/reviewBoardList.jsp").forward(request, response);
