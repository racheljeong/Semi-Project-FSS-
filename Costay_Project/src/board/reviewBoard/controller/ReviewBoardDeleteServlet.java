...
@WebServlet("/board/review/boardDelete")
...
//		System.out.println("rName@serlvet= [" + rName + "]"); //공백인지 확인용
		...
		//업무로직 
		int result = reviewService.deleteReviewBoard(boardNo);
		...
		response.sendRedirect(request.getContextPath() + "/board/review/boardList");
